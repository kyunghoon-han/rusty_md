...
#[path="../forceField/LennardJones.rs"] mod lennard_jones;
pub use lennard_jones::{lj_force};
...
pub fn lj_dynamics(molecule: &mut Molecule,
                   num_steps: i32,
    ...
    for step in 0..num_steps {
        /*
            Get the forces
        */
        let forces_vec: Vec<[f64; 3]> = lj_force(molecule);
        ...
        println!("Step: {}", step);
        println!("{:?}", molecule.coordinates);
        println!("{:?}", molecule.velocities);
        println!("");
